...
{ //List linked
	...
	void saveLL(unsigned char * savedLL);
	void restoreLL(unsigned char * savedLL, unsigned char *database);
	void updateLL(unsigned char * savedLL, unsigned char *database);
	int compareLL(unsigned char * savedLLold, unsigned char * savedLLnew);
	unsigned char * savedLLold;
	unsigned char * savedLLnew;
